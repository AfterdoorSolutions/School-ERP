...
(d=window.innerWidth,e=window.innerHeight):"undefined"!=typeof document.documentElement&&"undefined"!=typeof document.documentElement.clientWidth&&0!=document.documentElement.clientWidth?(d=document.documentElement.clientWidth,e=document.documentElement.clientHeight):(d=document.getElementsByTagName("body")[0].clientWidth,e=document.getElementsByTagName("body")[0].clientHeight);4==c.fullscreen&&(d=a(b).parent().innerWidth(),e=a(b).parent().innerHeight());"kenburns"==c.effect&&(c.fullscreen=1);1==
c.fullscreen&&a(b).css("height",e);a(b).css("width","100%");a(b).css("left","0");a(b).css("top","0");a(b).find(".image").each(function(){var g=e,f=d,h=0,k=0;4==c.fullscreen?(f>c.maxWidth&&(f=c.maxWidth),a(this).css({height:"auto",width:f+"px"}),a(this).css({position:"absolute",left:h+"px",top:k+"px"}),a(b).css("height",a(this).innerHeight()),d>f&&(h=(d-a(this).width())/2,a(this).css({left:h+"px"}))):(f/g>a(this).width()/a(this).height()?1==c.fullscreen?a(this).css({height:g+"px",width:"auto"}):2==
c.fullscreen&&a(this).css({height:"auto",width:f+"px"}):1==c.fullscreen?a(this).css({height:"auto",width:f+"px"}):2==c.fullscreen&&a(this).css({height:g+"px",width:"auto"}),1==c.fullscreen?(h=(d-a(this).width())/2,k=(e-a(this).height())/2):3==c.fullscreen&&a(this).css({height:g+"px",width:f+"px"}),a(this).css({position:"fixed",left:h+"px",top:k+"px"}))})}})(jQuery);