...
$color= '#c10402'; //red
$color2='#000'; //black (MENU COLOR)
$bodycolor= '#222'; //body color
$color3= "#F2DEDE"; //MENU SECOND ACTIVE
?>
/*
...
.nav-line > li.active > a:active,
.nav-line > li.active > a:focus {
    -moz-box-shadow: 0 3px 0 <?php echo $color; ?>;
    -webkit-box-shadow: 0 3px 0 <?php echo $color; ?>;
    box-shadow: 0 3px 0 <?php echo $color; ?>;
    margin: 0;
}
