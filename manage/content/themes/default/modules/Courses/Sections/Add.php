...
{
    $data=array('course_id'=>$_POST['course_id'],'name'=>$_POST['name'],'code'=>$_POST['code'],'status'=>$_POST['status'],'author'=>$_SESSION['author']);
    if(insert("section",$data)==1);
    $message=1;
...
?>          
      ...
      <div class="panel-heading">
        ...
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Section</h3>
      </div>
      ...
      <div class="panel-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Select Section </label>
                <div class="col-sm-8">
                  <select data-placeholder="Choose One" class="select-basic" name="course_id" required>
