        ...
        <header>
            <div class="headerwrapper">
                <div class="header-left">
                    <a href="" class="logo">
                      LOGO <!-- <img src="<?php echo ADMIN_THEME_PATH;?>images/logo.png" alt="" />  -->
                    </a>
                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group btn-group-option">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                              ...
                              <li class="divider"></li>
                              <li><a href="<?php echo menu_link("Settings","Logout");?>"><i class="glyphicon glyphicon-log-out"></i>Sign Out</a></li>
                              </ul>
                        </div><!-- btn-group -->
