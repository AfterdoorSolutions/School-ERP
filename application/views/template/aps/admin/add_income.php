...
<div class="contentpanel">
  <div class="row row-stat">
    <?php
      //var_dump($query);
      $attributes = array('class' => 'form-horizontal', 'id' => 'add_income');
      echo form_open('', $attributes);
    ?>
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading no-collapse"><h4 class="panel-title">Add Income</h4></div>
            ...
            <div class="col-md-6">
                <label class="control-label">Fee Account</label>
                  <?php
                    ...
                    echo form_dropdown('account_type', $options, '','class="form-control"');
                    ?>
        ...
        <div class="panel-footer"><?php echo form_submit('add_income', 'Submit','class="btn btn-primary"');?></div>
