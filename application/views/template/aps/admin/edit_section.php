  ...
  <div class="row row-stat">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  <label class="">Classes Name</label>
                    <?php
                    $query2 =$this->db->query("SELECT class_id,name FROM class"); 
                    $options= array(''=>"Select Any");
                    foreach ($query2->result() as $row)
                    {
                      $options[$row->class_id]=$row->name;
                    }
                    echo form_dropdown('class_id', $options, $query['class_id'],'class="form-control"');
                    ?>
        ...
        <div class="panel-footer"><?php echo form_submit('section', 'Update','class="btn btn-primary"');?></div>
