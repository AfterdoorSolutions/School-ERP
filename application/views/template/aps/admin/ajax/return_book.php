		      ...
		      if($query!=NULL)
		      {
					    ...
					    ?> 
			      		<tr>
				            ...
				            <td class="student_book_issue"><a href="" data-studentid='<?php echo $query->issue_to_id;?>' data-issueid="<?php echo $query->books_issued_id;?>" data-admnumber="<?php echo $query->adm_number;?>" class="student_book_issue">Reissue</td>
