  ...
  <div class="row row-stat">
    ...
    ?>
        ...
        <div class="panel-body">
          <h4>Fields marked with <em>*</em> must be filled.</h4>
...
<div class="form-group text-left">
              ...
              <div class="col-md-9">
                <select class="form-control" name="lang_understand">
            ...
            <div class="form-group text-left">
              ...
              <div class="col-md-9">
                ...
                ?>
                <?php echo form_error('student_category_id'); ?>
              </div>
            </div>
            ...
            <h4>Upload user's photo</h4>
            <div class="form-group text-left">
              <label class="col-md-3 control-label">Upload Image</label>
              <div class="col-md-9">
              <input type="file" name="image_c">
              </div>
            </div>
