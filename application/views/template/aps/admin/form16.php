...
<table class="table table-bordered table_input"> 
    <tr> <th colspan="5">Certificate under section 203 of the Income-tax Act, 1961 for Tax deducted a source from chargeable under the head "Salaries"</th> </tr> 
...
<tr>
    <td colspan="2"><?php echo form_input('mname'); ?></td>       
...
<tr>
        ...
        <td class="text-center"><label for="text">Assessment Year</label> </td>
...
<tr style="height:90px"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<tr><td colspan="2">a) Salary as per provisions contained in Sec.17(1)</td><td>Rs. <?php echo form_input('mname','','style="width:150px;"'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td colspan="2">b) Value of perquisites u/s 17(2) (as Form No.12BA, wherever applicable)</td><td>Rs. <?php echo form_input('mname','','style="width:150px;"'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td colspan="2">c) Profits in lieu of salary under section 17(3)(as per Form No.12BA, wherever applicable)</td><td>Rs.  <?php echo form_input('mname','','style="width:150px;"'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<tr><td colspan="5"><p>I ........son/daughter of.........working in the capacity of.........(designation) do hereby certify that a sum of Rs. ...(Rupees....(in words) has been deducted at source and paid to the credit of the central goverment. i further certify that the information given above is true and correct based on the book of accounts, documents and other available records.</p></td></tr>
...
<tr><td colspan="2">Place:</td><td colspan="2">Full Name</td><td>&nbsp;</td></tr>
