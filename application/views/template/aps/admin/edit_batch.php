            ...
            <div class="col-md-4">
              <label class="control-label">Class</label>
                <?php
                  ...
                  echo form_dropdown('class_id', $options, $query['class_id'],'class="form-control" id="get_section_class_change"');
                ?>
             </div><!-- col-md-4 -->
            ...
            <div class="col-md-4">
              <label class="control-label">Batch</label>
                <?php
                  ...
                  echo form_dropdown('batch_id', $options, $query['batch_id'],'class="form-control"');
                ?>
             </div><!-- col-md-4 -->
          </div><!-- row -->
        </div><!-- panel-body -->

        <div class="panel-footer"><?php echo form_submit('batches', 'Update','class="btn btn-primary"');?></div>
