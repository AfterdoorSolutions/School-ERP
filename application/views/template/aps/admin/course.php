<div class="content">
  ...
  ?>
      <div class="col-md-12">
        ...
        <textarea name="overview" class="form-control editors" id="editor1"><?php echo set_value('overview'); ?></textarea>
        <?php echo form_error('overview'); ?>
        </div>
        <div class="form-group">
        <label>Course Content</label>
        <textarea name="course_content" class="form-control editors" id="editor2"><?php echo set_value('course_content'); ?></textarea>
        <?php echo form_error('course_content'); ?>
        </div>
        <div class="form-group">
        <label>Course Category</label>
       <?php
                $query =$this->db->query("SELECT category_id,name FROM category"); 
                ...
                echo form_dropdown('category_id', $options, '','class="form-control"');
                ?>
        </div>
        <div class="form-group">
        <label>Partner</label>
        ...
        <textarea name="seo_content" class="form-control editors" id="editor3"><?php echo set_value('seo_content'); ?></textarea>
